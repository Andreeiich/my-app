...
function App() {
    ...
    React.useEffect(() => {
         ...
         const tyrsData= await  axios.get('https://637f91cc2f8f56e28e904eb7.mockapi.io/tyrs')
         /*.then((resJson) =>{
                setTyrs(resJson.data)
            })*/
            
    
            const cartData= await axios.get('https://637f91cc2f8f56e28e904eb7.mockapi.io/cart')/*.then((res) =>{
                setOverlayItems(res.data)
            })*/
          
           
          
            const favoritesData= await axios.get('https://637f91cc2f8f56e28e904eb7.mockapi.io/favorites')/*.then((res) => {setFavorites(res.data)})*/
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://637f91cc2f8f56e28e904eb7.mockapi.io/cart/${id}`)
    ...
    return (
                //чтобы пропсы были глобальными
            <AppContext.Provider
                  value={{
                      tyrs,setTyrs,overlayItems,setOverlayItems,favorites,setFavorites,
                      isAdded,isFav  
                  }}  
